...
def index():
    return f"<h1> Le super site </h1>  Ce site est construit à partir du framework Flask. <br> <a href = {url_for('p2')}> Lien vers la suite</a><br> <a href = {url_for('p3', name='Zian')}> Lien vers la troisieme page</a>"
...
@app.route("/troisieme/<name>")
def p3(name):
    return f"Nous sommes maintenant sur la page personnelle de {name} ! <br> <a href = {url_for('index')}> Lien vers l'index</a>"
