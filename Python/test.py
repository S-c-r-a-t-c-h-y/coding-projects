...
class Hanoi(tk.Tk):
    ...
    def __init__(self, nb_disques=3):
        ...
        self.COLORS = [
            self.rgb_to_hex(random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))
        ...
        self.text = self.canvas.create_text(self.WIDTH / 2, 20, text="0", font=font, justify="center")
